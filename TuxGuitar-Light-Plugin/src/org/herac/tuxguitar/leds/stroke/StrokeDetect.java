...
import com.ritolaaudio.javajack.midi.MIDIInputPort;
import com.ritolaaudio.javajack.midi.MIDIOutputPort;
        ...
        public StrokeDetect(LedsMidiSequencerImpl sequencer)
				...
				private long lastCount = 0;
                 ...
                 //               public void process(Map<String, FloatBuffer> audioIn,
                                public void process(Map  audioIn,
                                                Map  audioOut,
                                                Map  midiIn,
                                                Map  midiOut)
                                        {
                                        //elkafoury added the type cast
                                	//    final FloatBuffer aIn =  audioIn.get("GuitarIn");
                                        final FloatBuffer aIn = (FloatBuffer)audioIn.get("GuitarIn");
