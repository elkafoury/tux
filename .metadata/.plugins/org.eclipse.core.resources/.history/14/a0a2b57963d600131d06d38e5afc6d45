...
public interface PortConnectListener extends Serializable
	{
	public void portConnectEvent(Port firstPort, Port secondPort, boolean isConnecting, Client localClient);
	}
