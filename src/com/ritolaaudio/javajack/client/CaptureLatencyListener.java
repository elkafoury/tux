...
/**
 * Invoked when there is a reported change in a JACK Client's capture latency. 
 * Capture latency is the latency between a Server's input (terminal) port and this Client's input port, 
 * including the latencies incurred by intermediate Clients inserted along the way.
 * @author chuck
 *
 */
public interface CaptureLatencyListener extends Serializable
	{
	/**
	 ...
	 * @date	Oct 6, 2011
	 */
	public void recalculateCaptureLatency(Client localClient);
	}
